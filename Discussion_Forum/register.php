...
<script type="text/javascript">
	function check(form1) {
		if (form1.u_name.value == "" || form1.f_name.value == "" || form1.pwd.value == "" ||
			...
			form1.add.value == ""|| form1.sta.value == "" || form1.cou.value == "" ) {
...
<form action="registerH.php" method="post" onsubmit="return check(this)"
	...
	<table>
		...
		<tr>
			<td>E_Mail: </td>
			<td><input type="text" name="e_mail"><span id='d' style="color: red;"></span></td>
		</tr>
		<tr>
			<td>Gender: </td>
			<td><input type="radio" name="gender" value="1" checked="checked">Male
				<input type="radio" name="gender" value="2">Female<span id='spuid'
				style="color: red;"></span></td>
		</tr>
		<tr>
			<td>Birthday: </td>
			<td><input type="text" name="dob"><span id='e' style="color: red;"></span></td>
		</tr>
		<tr>
			<td>Profile Image: </td>
