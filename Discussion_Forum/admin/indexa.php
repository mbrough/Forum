                ...
                <div class="postContainerBody">
                	<div class="post-inner">
                        ...
                        <div class="postContent">
							<p align="justify">
								This website is the final project for TCSS 499. It is a forum which
								allows users to , post messages to and view threads, create 
								threads, and send private messages to other users. The forum will 
								use HTML, CSS to present the UI, PHP and MySQL to hold the database 
								of messages, users, threads, and posts, and JavaScript to show ads.
							</p>
							<b>From Wikipedia: </b>
							<p>
							...
							<p> 
							<a href="https://en.wikipedia.org/wiki/Internet_forum">Click here</a> for 
